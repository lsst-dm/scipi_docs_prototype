...
`command_line_task`_, which can be found on the CLTargs page.

.. _`command_line_task`: https://lsst-web.ncsa.illinois.edu/doxygen/x_masterDoxyDoc/classlsst_1_1pipe_1_1base_1_1cmd_line_task_1_1_cmd_line_task.html
